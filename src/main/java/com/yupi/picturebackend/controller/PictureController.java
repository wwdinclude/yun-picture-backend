...
import com.yupi.picturebackend.model.dto.space.SpaceLevel;
...
import com.yupi.picturebackend.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    private final Cache<String, String> LOCAL_CACHE = Caffeine.newBuilder()
            ...
            .expireAfterWrite(5L, TimeUnit.MINUTES) // 缓存过期时间5分钟
            .build();
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        if (spaceId == null) {
            ...
            //     throw new BusinessException(ErrorCode.NO_AUTH_ERROR, "您没有权限查看该空间的图片");
            // }
        }
        // 查询数据库
        Page<Picture> picturePage = pictureService.page(new Page<>(current, size),
